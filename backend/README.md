...
## Project Structure
    ...
    ├── testapiautostoryboa_92700  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_92700`
...
2. Clone this repo and `cd testapiautostoryboa_92700`
